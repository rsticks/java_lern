...
public class Main {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		PixelComponent pix = new PixelComponent(Color.BLACK, fr.getGraphics());
		ThreadsFract threadsFract = new ThreadsFract(data.clone(), 0, 250, pix.clone(), g);
		//ThreadsFract threadsFract1 = new ThreadsFract(data.clone(), 250, 500, pix.clone(), g);
		ThreadsFract threadsFract2 = new ThreadsFract(data.clone(), 500, 750, pix.clone(), g);
		//ThreadsFract threadsFract3 = new ThreadsFract(data.clone(), 750, 1000, pix.clone(), g);
